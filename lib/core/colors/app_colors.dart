...
class AppColors {
  ...
  static ColorScheme get lightColorScheme => ColorScheme.light(
        ...
        background: toColor(lightBackground),
        onBackground: toColor(lightForeground),
        surfaceVariant: toColor(lightMuted),
  ...
  static ColorScheme get darkColorScheme => ColorScheme.dark(
        ...
        background: toColor(darkBackground),
        onBackground: toColor(darkForeground),
        surfaceVariant: toColor(darkMuted),
