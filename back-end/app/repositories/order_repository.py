...
class OrderRepository:
    ...
    def get_user_order(self, order_id: int, user_id: int) -> Optional[Order]:
    ...
    def get_all_by_user_id(self, user_id: int, skip: int = 0, limit: int = 100) -> List[Order]:
    ...
    def create_order_from_cart(
        self, user_id: int, cart: Cart, order_data: OrderCreate
    ) -> Optional[Order]:
        """
